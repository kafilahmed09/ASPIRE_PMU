...
namespace ASPIRE.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            ViewData["AspireUserRoleId"] = new SelectList(_context.AspireUserRole, "AspireUserRoleId", "Name");
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            ViewData["DistrictId"] = new SelectList(_context.District, "DistrictId", "Name", Input.DistrictId);
            ViewData["AspireUserRoleId"] = new SelectList(_context.AspireUserRole, "AspireUserRoleId", "Name", Input.UserRoleId);
            return Page();
        }
    }
}
