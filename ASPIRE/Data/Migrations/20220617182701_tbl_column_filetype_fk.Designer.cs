...
namespace ASPIRE.Data.Migrations
{
    ...
    [Migration("20220617182701_tbl_column_filetype_fk")]
    partial class tbl_column_filetype_fk
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPIRE.Models.Domain.MasterSetup.FileType", b =>
                {
                    ...
                    b.ToTable("FileType", "master");
                });

            modelBuilder.Entity("ASPIRE.Models.Domain.MasterSetup.Indicator", b =>
                {
            ...
            modelBuilder.Entity("ASPIRE.Models.Domain.MasterSetup.School", b =>
                {
                    ...
                    b.Property<string>("DistanceOfNearestWaterSource")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("District")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("DtmCreatedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("VchCreatedBy")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ASPIRE.Models.Domain.Schools.IndicatorEvidence", b =>
                {
                    b.Property<int>("IndicatorEvidenceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("IndicatorEvidence", "Schools");
                });
            ...
            modelBuilder.Entity("ASPIRE.Models.Domain.Schools.IndicatorEvidence", b =>
                {
                    b.HasOne("ASPIRE.Models.Domain.MasterSetup.FileType", "FileType")
                        .WithMany()
                        .HasForeignKey("FileTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASPIRE.Models.Domain.MasterSetup.Indicator", "Indicator")
                        .WithMany()
                        .HasForeignKey("IndicatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASPIRE.Models.Domain.MasterSetup.School", "School")
                        .WithMany()
